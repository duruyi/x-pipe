...
-- insert into route_tbl(id, route_org_id, src_dc_id, dst_dc_id, src_proxy_ids, dst_proxy_ids, active, tag, deleted) values (1, 0, 3, 1, '0,4', '3,7', 1, 'CONSOLE', 0);
-- insert into route_tbl(id, route_org_id, src_dc_id, dst_dc_id, src_proxy_ids, dst_proxy_ids, active, tag, deleted) values (2, 0, 1, 3, '2,6', '1,5', 1, 'CONSOLE', 0);

insert into route_tbl(id, route_org_id, src_dc_id, dst_dc_id, src_proxy_ids, dst_proxy_ids, active, tag, deleted) values (1, 0, 3, 1, '', '0,4', 1, 'CONSOLE', 0);
insert into route_tbl(id, route_org_id, src_dc_id, dst_dc_id, src_proxy_ids, dst_proxy_ids, active, tag, deleted) values (2, 0, 1, 3, '', '2,6', 1, 'CONSOLE', 0);